...
alter table users_owned_by
    add constraint FKqsn5ohuprxkk1s7cd348e8btl foreign key (owned_by_id) references item;
alter table users_owned_by
    add constraint FK2d6a73d4l6qaq1th7ni5po6rj foreign key (all_users_userid) references users;
